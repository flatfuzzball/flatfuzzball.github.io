...
global_variables() {
    ...
    # Blog title
    global_title="Flat's blog'"
    # The typical subtitle for each blog
    global_description="My (rarely updated) blog"
    # The public base URL for this blog
    global_url="https://flatfuzzball.github.io/blog"

    # Your name
    global_author="flat"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="https://flatfuzzball.github.io"
    # Your email
    global_email="flatfuzzball@gmail.com"
